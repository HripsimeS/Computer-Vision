...
root_dir  = '../projects/CTPelvic1K_data/train_dir'
inference  = '../projects/CTPelvic1K_data/test_images'

def main(inference):
    print_config()
    logging.basicConfig(stream=sys.stdout, level=logging.INFO)

    test_images = sorted(glob.glob(os.path.join(inference, "*data.nii.gz")))
    ...
    model.load_state_dict(torch.load(os.path.join(root_dir, "3DUnet_best_metric_model.pth")))
